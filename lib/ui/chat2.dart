...
import 'package:modjiappfournisseur/widgets/cards/card42.dart';
import 'theme.dart';
      ...
      if (_lastTime != null)
        if (_time.year != _lastTime.year || _time.month != _lastTime.month ||
          ...
          list.add(Center(child: Container(
            ...
            dateFormat).format(_time), style: theme.style14W600Black,),)));
      _lastTime = _time;
