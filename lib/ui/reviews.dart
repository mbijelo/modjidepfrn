...
import 'strings.dart';
import 'package:modjiappfournisseur/widgets/cards/card46.dart';
import 'theme.dart';
          ...
          children: <Widget>[
            ...
            ClipPath(
                ...
                child: Container(
                    ...
                    width: windowWidth,
                    child: card46(
                        rating.isNaN ? "0" : rating.toStringAsFixed(1), theme.style25W800whit,
                        strings.get(75), /// "Average Ratings",
                        theme.style12W600White,
                        Image.asset("assets/ondemand/ondemand13.png", fit: BoxFit.cover),
                        windowWidth, (theme.darkMode) ? Colors.black : Colors.black54, (){}
                    )
                )),

            appbar1(Colors.transparent, (theme.darkMode) ? Colors.white : Colors.white, "", context, () {
