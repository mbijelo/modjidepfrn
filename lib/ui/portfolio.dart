        ...
        children: [
          ...
          Container(
            ...
            child: Column(
              ...
              children: [
                Text(strings.get(288), /// "Chat",
                  style: theme.style14W600White,),
               /* Text(strings.get(288), /// Chatting online
                    style: theme.style14W600White),
                */
                SizedBox(height: 28,),
              ],
...
*/
  ...
  _body(){
    ...
    _mainModel.customerAppLangsComboValue = "fr";
/*
    list.add(Container(
 ...
 /// "Change",
            ...
            Expanded(child: Column(
              ...
              children: [
                ...
                SizedBox(height: 5,),
                button2small(strings.get(139), _changeIcon),
...
*/
  ...
  _saveName() async {
    ...
    if(_editControllerName.text == ""){
      return messageError(context, strings.get(115));
    }
